...
CUDA_VISIBLE_DEVICES=$1 python test.py --name ${model} \
    ...
    --dataset_mode unaligned --dataroot_A /scratch/users/aditya/data/singleview_opendr_real_ratio --dataroot_B /scratch/users/aditya/cycada_data/singleview_opendr_solid \
