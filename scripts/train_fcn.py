...
# TODO: Move transforms to a different file
def compose_transforms(downscale):
    transform = []
    target_transform = []
    #TODO: What is downscale being used for?
    ...
    # Converting PIL to tensor and mean-std normalization, What if the dataloader itself returns tensors?
    # TODO: Replace mean and variance corresponding to our dataset
    # TODO: Mean-Std normalization vs MaxMix normalization - Which to choose and when?
